...
from app.api.v1.endpoints import user, article, chat, delivery, image, message, notification, order, review, service_category, service, store, auth, map, upload, data
...
api_router.include_router(
    map.router, prefix="/map", tags=["map"]
)
